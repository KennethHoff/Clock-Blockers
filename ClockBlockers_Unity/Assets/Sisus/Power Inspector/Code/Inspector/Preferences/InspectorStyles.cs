...
namespace Sisus
{
	public class InspectorStyles
	{
		...
		public InspectorStyles([NotNull]GUISkin skin)
		{
			...
			if(PopupMenuTitle == null)
			{
				PopupMenuTitle = new GUIStyle(GUI.skin.label);
				PopupMenuTitle.fontStyle = FontStyle.Bold;
				PopupMenuTitle.SetAllTextColors(theme.PrefixIdleText);
