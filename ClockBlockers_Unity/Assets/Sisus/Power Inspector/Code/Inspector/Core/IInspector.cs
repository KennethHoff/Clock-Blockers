...
namespace Sisus
{
	public interface IInspector
	{
		...
		/// <summary> Gets a value indicating whether inspector's filter field currently has a filter. </summary>
		...
		void OnProjectOrHierarchyChanged(OnChangedEventSubject changed);
